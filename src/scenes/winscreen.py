...
class WinScreen:
    ...
    def run(self, game, events):
        ...
        draw_text(self.game_screen, TITLE_FONT_PATH, 80, get_text(self.translations, game.current_lang, f"wingame_title-{self.level_id}"), "white", WINDOW_WIDTH / 2, WINDOW_HEIGHT / 3 - 120)
        draw_text_space(self.game_screen, TITLE_FONT_PATH, 50, get_text(self.translations, game.current_lang, f"wingame_subtitle-{self.level_id}"), "white", WINDOW_WIDTH / 2, WINDOW_HEIGHT / 3 + 30)
